...
export declare interface XcodeUngroupedFileTreeObject extends XcodeBaseFileTreeObject {
    /**
     * An Xcode-internal identifier that describes the base path that the `path` property should be interpreted relative to. Possible values include:
     * 
...
export declare interface XcodeGroupedFileTreeObject extends XcodeBaseFileTreeObject {
    ...
    sourceTree: `"<group>"`;
    /**
     * A UNIX path to the this object in Xcode's file tree. This is likely to correspond to a backing object in the operating system's filesystem, but that isn't necessarily the case, as some objects (such as folderless groups) are only representeed within Xcode. The base path this path is relative to is defined by the `sourceTree`. This is equivalent to the `name` property of filesystem objects that aren't located relative to their direct parent group
     */
    path: string;
}
 ...
 */
 export declare type PBXBaseFileReference = XcodeAbstractFileTreeObject & {
    ...
    /**
     * A code that indicates the text encoding that the file uses. Options are:
     * 
     * - `4`: Unicode (UTF-8)
     * - `10`: Unicode (UTF-16)
