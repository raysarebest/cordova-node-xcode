 ...
 * @param {object} parent An object that contains key/value pairs that might have corresponding comments
 ...
 * @returns {obj is Array} `true` if the `obj` is an array, `false` if it is not
 */
